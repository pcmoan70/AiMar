...
export type HintKey =
  ...
  | 'liceMean' | 'liceMax' | 'liceAbove' | 'liceTreat' | 'cases' | 'casesPanel' | 'treatmentHeat' | 'heatRadius' | 'tides' | 'liceWeek' | 'liceHeat' | 'seasonWeek' | 'warmSites' | 'climMonth' | 'application' | 'hearings' | 'evaluation'
