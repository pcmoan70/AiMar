...
export const HINTS = {
  ...
  liceChart: `Weekly average adult female lice per fish, from 2012 when weekly reporting started; the Period dropdown shows the last year, 4 or 8 years, or everything. Red line = 0.5 limit; grey bands = weeks reported as fallow; ▲ mechanical removal, ◆ medicinal treatment. Hover the chart for values. ${BW}`,
