export default function HelpPanel() {
  return (
    <div className="panel-body">
      ...
      <h3>Using the map</h3>
      <ul>
        <li>Click a coloured dot to see a locality's register entry.</li>
        <li>Click anywhere else in the sea to profile a hypothetical site: nearest farm and farms within 5–50 km.</li>
      ...
      <ul>
        ...
        <li>Fiskeridirektoratet: localities, site polygons, spawning areas, protected seabed habitats (NLOD 2.0).</li>
