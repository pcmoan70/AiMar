...
| `lib/filters.ts` | Register-field filters (equality, capacity threshold, species membership) combined with the operator selection into a locality-number list for the map |
